...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('css/login.css', \App::environment() == 'production') }}" >
                ...
                <div class="wrapper fadeInDown">
                    <div id="formContent">
                        ...
                        <div class="fadeIn first">
                            <img src="{{ asset('images/logo.png', \App::environment() == 'production') }}" id="icon" alt="User Icon" />
                        </div>
